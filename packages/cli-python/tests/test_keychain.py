...
from mcplock.keychain import delete_secret, get_secret, set_secret

TEST_ACCOUNT = "test-account-mcplock-pytest"
...
def test_returns_none_for_a_secret_that_was_never_set():
    assert get_secret("account-that-does-not-exist-mcplock-pytest") is None
